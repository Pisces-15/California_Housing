...
The application allows users to input housing features such as **median income, house age, number of rooms, population, and geographic location** to estimate the house price using a trained machine learning model.
...
🔗 https://californiahousing-ggtvfkre4rq3ccmgpsau2s.streamlit.app/
...
* Ability to capture complex patterns in datasets

The trained model is saved as a **Pickle (.pkl) file** and loaded into the Streamlit application to generate predictions.
